...
import logging
logger = logging.getLogger('janitoo.audiovideo')
...
class AudioVideoServer(JNTServer):
    """The AudioVideo Server
    ...
    def _get_egg_path(self):
        ...
        """
        try:
            _dist = get_distribution('janitoo_audiovideo')
            return _dist.__file__
        except AttributeError:
            return os.path.join("/opt/janitoo/src",'src-audiovideo/config')
